...
@customElement("page-demo")
class PageDemo extends PageUI5Base {
    override get title():string {return "UI5 Page Demo"}
    ...
    override get footer():TemplateResult {return html`
        <ui5-bar design="FloatingFooter">
            ...
            <ui5-button design="Transparent" slot="endContent"
                @click=${():void=>{
                    this.dispatchCustomEvent("DemoEvent",{action:"cancel"})
                }}>Cancel</ui5-button>
        </ui5-bar>
    `}
}
declare global { interface HTMLElementTagNameMap { "page-demo": PageDemo}}